...
def retrieve_evidence(
    ...
    # If a code is unknown or ambiguous, the symptom is valuable
    # disambiguating evidence; do not silently discard it when a code exists.
    search_text = " ".join(
        part for part in (query.code, query.symptom) if part and part.strip()
    )
