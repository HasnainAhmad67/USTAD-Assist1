...
def run_troubleshoot(
    ...
    try:
        ...
        # Verified evidence alone is not a complete user-facing answer: the
        # contract requires grounded generation before the result can be
        # presented as validated guidance. Keep the evidence for diagnosis and
        # auditability, but let validation emit the explicit error status.
        grounded_answer = None
